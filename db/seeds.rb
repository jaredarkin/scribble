...
pbj = Post.create(title: "Peanut Butter Jelly Time", photo_url: "http:www.placebear.com/300/300", user: jared, body: "Bresaola rump ball tip, pancetta pork brisket capicola landjaeger kevin chicken tongue pork chop spare ribs tenderloin ham. Venison ham hock short ribs pastrami turkey hamburger ground round. Frankfurter capicola swine doner. Chicken kevin cupim bacon leberkas ham, doner jowl rump shank.")
bluth = Post.create(title: "Illusions, Michael", photo_url: "http:www.placebear.com/300/300", user: jared, body: "He's a regular Freddie Wilson, that one. We need a name. Maybe 'Operation Hot Mother'. How about a turtle? I've always loved those leathery little snappy faces. That coat costs more than your house! Ann certainly has a great deal of Mass. I'll sacrifice anything for my children. I will pack your sweet pink mouth with so much ice cream you'll be the envy of every Jerry and Jane on the block!")
rick = Post.create(title: "A Rick in Time", photo_url: "http:www.placebear.com/300/300", user: joe, body: "Well we're movin' on up to the east side to a deluxe apartment in the sky. Come and knock on our door. We've been waiting for you. Where the kisses are hers and hers and his. Three's company too. Fleeing from the Cylon tyranny the last Battlestar – Galactica - leads a rag-tag fugitive fleet on a lonely quest - a shining planet known as Earth.")
